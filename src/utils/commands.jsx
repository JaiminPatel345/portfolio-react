...
`}      
  ...
  experience: (
      <span>
      <p><strong style={{color: '#64ffda'}}><a href={`https://passdn.com/`}
  ...
  projects: (
      <span>
      <p><strong style={{color: '#64ffda'}}>ABHINAVAM</strong> | Social Media Mobile App | <em>March – April 2025</em></p>
      ...
      <p><strong style={{color: '#64ffda'}}>WANDERLUST</strong> | Travel & Accommodation Booking Platform | <em>Aug – Dec 2023</em></p>
      ...
      <br/>
      <p>Type <strong style={{color: '#ffff80'}}>projects_all</strong> to see all projects</p>
      <br/>
      <p>Type <strong style={{color: '#ffff80'}}>skills</strong> to see my technical expertise!</p>
    </span>
  ),
  ...
  projects_all: (
    ...
    <p><strong style={{color: '#64ffda'}}>BARTER TALK</strong> | Real-time Messaging & Video Calling App | <em>Nov – Dec 2024</em></p>
    ...
    <p><strong style={{color: '#64ffda'}}>LOCKSMITH</strong> | Password & Document Manager App | <em>Dec 2024 – Jan 2025</em></p>
    ...
    <p><strong style={{color: '#64ffda'}}>HEALTH PIE</strong> | Health Tracking & Doctor-Patient Platform | <em>Aug – Sep 2024</em></p>
    ...
    <p><strong style={{color: '#64ffda'}}>GDGC BVM</strong> | Official Website for GDGC Club at BVM | <em>Nov 2024</em></p>
    ...
    <p>Type <strong style={{color: '#ffff80'}}>skills</strong> to view my technical expertise!</p>
  </span>
  ),
  ...
  education: (
      ...
      <div>
        <p><strong
            style={{color: '#64ffda'}}>Birla Vishvakarma Mahavidyalaya</strong>, Anand, Gujarat</p>
      ...
      <div>
        <p><strong
            style={{color: '#64ffda'}}>Baroda High School Danteshwar</strong>, Vadodara, Gujarat</p>
      ...
      <div>
        <p><strong
            style={{color: '#64ffda'}}>Nutan Vidyalaya</strong>, Vadodara, Gujarat</p>
        <p>Gujarat Board | till 2020 </p>
        <p>• SSC: 86.83%</p>
        <br/>
      </div>
      <br/>
      <p>Type <strong style={{color: '#ffff80'}}>activities</strong> to see my campus involvement!</p>
    </span>
  ),
  ...
  achievements: (
      <span>
      <p>🏆 <strong
          style={{color: '#64ffda'}}>Odoo x Mindbend Hackathon &#39;25</strong> (at SVNIT) finalist</p>
      <p>🥇 <strong style={{color: '#64ffda'}}>1st Rank</strong> in Byte Quest, college coding competition</p>
      <p>🏅 <strong style={{color: '#64ffda'}}>19th Rank</strong> in GeeksForGeeks Weekly contest 135</p>
      <p>🏅 <strong style={{color: '#64ffda'}}>53rd Rank</strong> in GeeksForGeeks Weekly contest 129</p>
      <p>🎯 Qualified <strong
          style={{color: '#64ffda'}}>JEE Advanced 2022</strong> with AIR 28k</p>
      <br/>
      <p>Type <strong style={{color: '#ffff80'}}>dsa</strong> to see my competitive programming stats!</p>
    </span>
  ),
  ...
  contact: (
      ...
      <br/>
      <p>Type <strong style={{color: '#ffff80'}}>socials</strong> to connect with me online!</p>
    </span>
  ),
  ...
  activities: (
      ...
      <p><a target={'_blank'}
            ...
            }><strong style={{color: '#64ffda'}}>Google Developer Groups On Campus BVM</strong></a></p>
  ...
  contributions: (
      ...
      <p>🌟 <a target={'_blank'}
          ...
          style={{color: '#64ffda'}}>Free Code Camp</strong></a> - Contributed documentation improvements</p>
      <p>🌟 <a target={'_blank'}
              href={`https://github.com/cboard-org/cboard`}><strong
          style={{color: '#64ffda'}}>Cboard</strong></a> - Assisted with open source AAC communication tool</p>
      <br/>
  ...
  dsa: (
      ...
      <p>🔥 <a target={'_blank'}
          ...
          style={{color: '#64ffda'}}>Leetcode:</strong></a> Top 6% in contests</p>
        
      <p>⭐ <a href={`https://www.codechef.com/users/jaimin_patel_3`}
              target={'_blank'}><strong
          style={{color: '#64ffda'}}>Codechef:</strong></a> 3-star rated coder</p>
      <br/>
