    ...
    const projects = [
        {
            ...
            points: [
                ...
                `Developed blockchain-backed credential verification system with IPFS storage, multi-identifier verification (credential_id, tx_hash, IPFS CID, QR code), and SHA256 data integrity hashing.`,
                `Created external credential sync system with BullMQ job queues to automatically poll and integrate credentials from multiple providers (NSDC, Udemy) with course hour validation and AI processing.`,
                `Built comprehensive employer platform with advanced candidate search (skills, NSQF level, location), AI chatbot for profile queries, and detailed learner credential viewing.`,
                `Implemented production-grade practices including JWT + OAuth 2.0 authentication, Redis-backed job queues, Prisma ORM with PostgreSQL, rate limiting, and comprehensive test coverage with Jest.`,
            ],
            technology: [
                'TypeScript',
                'Node.js',
            ...
            time: 'Nov - Dec 2025',
            github: 'https://github.com/JaiminPatel345/MicroMerit-Portal',
        },
        {
            title: 'Quizzer',
