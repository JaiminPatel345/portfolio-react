      ...
      <div className="max-w-6xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {contributions.map((contribution, index) => (
            ...
            >
              <div
                className="bg-white dark:bg-neutral-800 rounded-xl overflow-hidden shadow-lg  transition-all duration-300 border border-neutral-200 dark:border-neutral-700 hover:shadow-xl hover:border-blue-300 dark:hover:border-blue-500">
                <div
