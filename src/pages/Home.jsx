        ...
        >
          <div className="relative w-full">
            <h1 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-neutral-900 to-neutral-600 dark:from-white dark:to-neutral-400 whitespace-nowrap">
              Jaimin <span className="relative inline-block">
                <span className="text-blue-500 dark:text-blue-400">Detroja</span>
                <span className="absolute -top-5 -right-4 sm:-right-8 md:-top-6 md:-right-24 bg-emerald-50 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 text-[9px] sm:text-[10px] md:text-xs font-semibold px-1.5 md:px-2 py-0.5 rounded-full border border-emerald-200 dark:border-emerald-800 flex items-center gap-1 md:gap-1.5 shadow-sm transform hover:scale-105 transition-transform cursor-default z-10">
